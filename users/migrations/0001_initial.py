...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=users.utils.generate_professor_id, editable=False, max_length=8, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=users.utils.generate_student_id, editable=False, max_length=8, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=users.utils.generate_assistant_id, editable=False, max_length=8, unique=True)),
                ('faculty', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='university.faculty')),
                ('major', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='university.major')),
